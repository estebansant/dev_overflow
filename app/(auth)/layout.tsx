...
const AuthLayout = ({ children }: { children: ReactNode }) => {
  return (
    <main className="bg-no-repepat flex min-h-screen w-full items-center justify-center bg-[url('/images/auth-light.png')] bg-cover bg-center px-4 py-10 dark:bg-[url('/images/auth-dark.png')]">
